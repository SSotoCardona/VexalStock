...
export default function Register() {
  ...
  // Monitor showOtp changes
  useEffect(() => {
    console.log("showOtp changed to:", showOtp);
    window.__registerDebug = { showOtp, setShowOtp };
  }, [showOtp]);
  ...
  return (
    ...
    >
      <div className="mb-4 text-xs text-muted-foreground">DEBUG showOtp: {String(showOtp)}</div>
      {showOtp ? (
        <>
          {error && (
